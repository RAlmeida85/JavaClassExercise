...
//    * The isCatPlaying method needs to be defined as public static like we have been do
    ...
    public static void main(String[] args) {
        System.out.println("Result = " + isCatPlaying(true, 10));
        System.out.println("Result = " + isCatPlaying(false, 36));
        System.out.println("Result = " + isCatPlaying(false, 35));
        System.out.println("Result = " + isCatPlaying(true, 39));
    }
